      ...
      <div className='bg-muted relative hidden h-full flex-col p-10 text-white lg:flex dark:border-r'>
        ...
        <div className='relative z-20 mt-auto'>
          <blockquote className='space-y-2'>
            <p className='text-lg'>
              &ldquo;The centralized dashboard for managing all your ride partner operations
              with ease and security.&rdquo;
            </p>
            <footer className='text-sm'>System Administration</footer>
          </blockquote>
        </div>
      </div>
      <div className='flex h-full items-center justify-center p-4 lg:p-8'>
        <div className='flex w-full max-w-md flex-col items-center justify-center space-y-6'>
          ...
          <div className='text-muted-foreground space-y-2 px-8 text-center text-xs'>
            <p>
              Access restricted to <strong>Super Admins</strong> only.
            </p>
