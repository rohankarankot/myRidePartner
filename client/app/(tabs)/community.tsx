    ...
    return (
        ...
        >
            ...
            >
                ...
                <View style={styles.headerTitleWrap}>
                    ...
                    <Text style={[styles.headerSubtitle, { color: subtextColor }]}>
                        Public group for all riders
                    </Text>
                </View>

                <TouchableOpacity
                    onPress={() => router.push('/community-info')}
                    style={[styles.headerIconButton, { backgroundColor: `${primaryColor}12` }]}
                >
            ...
            <GiftedChat
                ...
                messagesContainerStyle={{ backgroundColor, paddingTop: headerHeight }}
                renderAvatarOnTop
