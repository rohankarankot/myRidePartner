...
export interface ApiJoinRequestJoinRequest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    requestedSeats: Schema.Attribute.Integer &
      Schema.Attribute.Required &
...
export interface ApiRatingRating extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User ratings for trips';
    displayName: 'Rating';
    pluralName: 'ratings';
    singularName: 'rating';
  };
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    ratee: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    rater: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
...
export interface ApiTripTrip extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isPriceCalculated: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    joinRequests: Schema.Attribute.Relation<
      'oneToMany',
      'api::join-request.join-request'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    status: Schema.Attribute.Enumeration<
      ['PUBLISHED', 'STARTED', 'CANCELLED', 'COMPLETED']
    > &
...
export interface ApiUserProfileUserProfile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    governmentIdVerified: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    ...
    ratingsCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
