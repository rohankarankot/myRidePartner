    ...
    <Box className="mx-6 rounded-[32px] p-6 mb-6 shadow-sm border" style={{ backgroundColor: cardColor }}>
      ...
      <VStack space="xl">
        ...
        <HStack className="justify-between items-center">
          <HStack space="md" className="items-center">
            <Box className="w-10 h-10 rounded-full bg-gray-50 items-center justify-center shadow-sm">
              <IconSymbol name="mappin.circle.fill" size={16} color={subtextColor} />
            </Box>
            <VStack>
              <Text className="text-[10px] font-extrabold uppercase tracking-widest" style={{ color: subtextColor }}>Location</Text>
              <Text className="text-base font-bold" style={{ color: textColor }}>{city || 'Not set'}</Text>
            </VStack>
          </HStack>
        </HStack>
